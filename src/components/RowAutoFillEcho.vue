  ...
  <div class="d-flex flex-column w-100">
    <div class="d-flex flex-row mb-4">
      <v-select v-model="echoes.data.base_attr" :items="getResonatorBaseAttrs()" :label="$t('general.base_attr')"
        @update:modelValue="updateEchoesWith43311(resonator.data, weapon.data, echoes.data)" variant="outlined"
    ...
    <div v-for="(e, i) in echoes.data.echoes" class="d-flex flex-row mb-4" :key="i">
