  ...
  <div class="d-flex flex-column w-100">
    ...
    <v-container class="mb-12">
      <div class="d-flex flex-column">
        ...
        <v-data-table class="table mb-6" :headers="headers" :items="templateRows" items-per-page="10" show-select
          v-model:selected="selectedItems" disable-sort>
          <template v-slot:header.data-table-select>
        ...
        <Rotation :rotation="r" :key="JSON.stringify(templateRows)" />
      </div>
    </v-container>
  </div>
</template>
...
// "hit": "1",
// "buffs": [],
// "resonating_spin_concerto_regen": "",
// "accumulated_resonating_spin_concerto_regen": "",
// "time_start": "",
// "time_end": "",
// "cumulative_time": "",
// "frame": "",
// "comment": "共鳴技能觸發合鳴效果，有沒有擊中無所謂。"
